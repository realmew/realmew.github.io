    ...
    <div className={`relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden ${inter.className}`}>
      ...
      >
        ...
        <p className="text-lg text-gray-700 text-center mb-6">
          🎨 <strong>Welcome to VISION!</strong> Explore our complete creative platform featuring live voting, art galleries, team profiles, and archive collections. Navigate through all sections to discover our full creative universe.
        </p>
      </motion.div>
      <MuteButton src="/Web.wav" />
    </div>
  );
}
