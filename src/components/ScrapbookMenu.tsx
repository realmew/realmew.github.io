      ...
      <AnimatePresence>
        {open && (
          ...
          >
            ...
            <a href="/" className="px-5 py-2 mb-2 bg-[#f8e8ff] rounded-lg shadow border-2 border-[#d1b3e0] border-dashed hover:bg-[#fffbe7] transition-colors rotate-[-4deg] -ml-3 scrapbook-link relative z-20 text-[#6d5a8d] font-bold">Home
            ...
            <a href="/portfolio" className="px-5 py-2 mb-2 bg-[#fffbe7] rounded-lg shadow border-2 border-[#f7d8b7] border-dashed hover:bg-[#f8e8ff] transition-colors rotate-[3deg] ml-4 scrapbook-link relative z-20 text-[#6d5a8d] font-bold">Portfolio
            ...
            <a href="/contact" className="px-5 py-2 mb-2 bg-[#e0f7fa] rounded-lg shadow border-2 border-[#b3e0e0] border-dashed hover:bg-[#f8e8ff] transition-colors rotate-[-2deg] -ml-2 scrapbook-link relative z-20 text-[#6d5a8d] font-bold">Contact
            ...
            <a href="/art" className="px-5 py-2 bg-[#ffe7fa] rounded-lg shadow border-2 border-[#e0b3d7] border-dashed hover:bg-[#fffbe7] transition-colors rotate-[2deg] ml-2 scrapbook-link relative z-20 text-[#6d5a8d] font-bold">Art Gallery
